...
(* First Definition *)
let pvc_pellet_metrics : material_metrics = { hs_code = Hs_code.of_string "3904.10"; origin = "CHN"; cost = 5.00 }
let paint_metrics      : material_metrics = { hs_code = Hs_code.of_string "3208.20"; origin = "JPN"; cost = 2.50 }
let box_metrics        : material_metrics = { hs_code = Hs_code.of_string "4819.10"; origin = "VNM"; cost = 1.50 }

let pvc_pellet : material = { metadata = Some {id = "mat-pvc-001"; name = "PVC pellets"}; trade_metrics = pvc_pellet_metrics }
let paint      : material = { metadata = Some {id = "mat-paint-001"; name = "Acrylic paint"}; trade_metrics = paint_metrics }
let box        : material = { metadata = Some {id = "mat-box-001"; name = "Cardboard box"}; trade_metrics = box_metrics }
...
let miku_def_2 : product = {
  ...
  trade_metrics = {
    ...
    destination_country = "MEX";
    bill_of_materials = [
      { metadata = Some { id = "mat-pvc-001"; name = "PVC pellets" }; trade_metrics = { hs_code = Hs_code.of_string "3904.10"; origin = "CHN"; cost = 5.00 } };
      { metadata = Some { id = "mat-paint-001"; name = "Acrylic paint" }; trade_metrics = { hs_code = Hs_code.of_string "3208.20"; origin = "JPN"; cost = 2.50 } };
      { metadata = Some { id = "mat-box-001"; name = "Cardboard box" }; trade_metrics = { hs_code = Hs_code.of_string "4819.10"; origin = "VNM"; cost = 1.50 } };
    ];
  };
}
...
let strip_metadata (p : product) : product =
  ...
  { metadata = None;
    trade_metrics = { p.trade_metrics with 
...
let test_absolute_equality () =
  ...
  Alcotest.(check bool) "Def 1 and Def 2 are structurally identical" true (miku_def_1 = miku_def_2)
...
let test_functional_equality () =
  ...
  Alcotest.(check bool) "Def 1 equals Def 3 (excluding metadata)" true (stripped_1 = miku_def_3);
  Alcotest.(check bool) "Def 2 equals Def 3 (excluding metadata)" true (stripped_2 = miku_def_3)
